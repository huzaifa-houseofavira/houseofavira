...
const categoryMeta = {
  women: {
    title: "Imported Women's Clothing India â€” Premium Dresses, Tops & Luxury Fashion | House of Avira",
  ...
  men: {
    title: "Imported Men's Clothing India â€” Premium Streetwear, Old Money Fashion & Luxury | House of Avira",
  ...
  footwear: {
    title: "Imported Footwear India â€” Premium Heels, Boots & Luxury Shoes | House of Avira",
  ...
  bags: {
    title: "Luxury Imported Bags India â€” Premium Handbags, Shoulder & Mini Bags | House of Avira",
  ...
  accessories: {
    title: "Premium Fashion Accessories India â€” Imported Jewelry, Belts & Luxury Add-Ons | House of Avira",
  ...
  collectibles: {
    title: "Imported Collectibles India â€” Sanrio, Nagano Characters, Blind Boxes & More | House of Avira",
  ...
  pets: {
    title: "Imported Pet Fashion India â€” Cute Pet Clothes, Toys & Accessories | House of Avira",
...
const subCategoryMeta = {
  ...
  'women/skirts': { title: "Imported Skirts for Women India", desc: "Shop imported skirts â€” mini, midi, maxi & pleated styles. Premium quality, Pinterest-inspired designs delivered to India." },
  'women/dresses': { title: "Imported Dresses for Women India", desc: "Shop premium imported dresses â€” party dresses, casual dresses, vacation wear & wedding guest outfits delivered to India." },
  'women/jackets': { title: "Imported Jackets for Women India", desc: "Premium imported women's jackets â€” blazers, leather jackets, denim & outerwear from international fashion." },
  ...
  'men/tops': { title: "Imported Tops & T-shirts for Men India", desc: "Shop premium imported men's tops â€” oversized tees, polo shirts, graphic tees & streetwear from international brands." },
  ...
  'men/jackets': { title: "Imported Jackets for Men India", desc: "Premium imported men's jackets â€” bombers, denim, leather & outerwear. Old money & streetwear aesthetics." },
  'footwear/heels': { 
    title: "Imported Heels & Stilettos India â€” Pinterest Aesthetics & Premium Footwear", 
  ...
  'footwear/boots': { title: "Imported Boots India", desc: "Premium imported boots â€” ankle boots, combat boots, Chelsea boots & knee-highs from international fashion." },
  'footwear/shoes': { title: "Imported Shoes India", desc: "Shop imported shoes â€” sneakers, loafers, oxfords & casual shoes. Premium international footwear delivered to India." },
  'footwear/flats': { title: "Imported Flats India", desc: "Comfortable imported flats â€” ballet flats, mules, slides & slip-ons. Premium quality at House of Avira." },
  'bags/handbags': { title: "Imported Handbags India", desc: "Shop luxury imported handbags â€” totes, satchels, structured bags & designer-inspired handbags delivered to India." },
  'bags/mini-bags': { title: "Imported Mini Bags India", desc: "Trendy imported mini bags â€” crossbody, clutches, evening bags & micro bags from international fashion trends." },
  'bags/shoulder-bags': { title: "Imported Shoulder Bags India", desc: "Premium imported shoulder bags â€” hobo bags, bucket bags & classic shoulder styles from international brands." },
  'accessories/jewellery': { title: "Imported Jewelry & Watches India", desc: "Shop premium imported jewelry and watches â€” necklaces, rings, bracelets, earrings & watches from House of Avira." },
  ...
  'accessories/hair': { title: "Imported Hair Accessories & Wigs India", desc: "Trendy imported hair accessories & wigs â€” clips, bands, scrunchies, claw clips & wigs from international fashion." },
  'accessories/belts': { title: "Imported Belts & Caps India", desc: "Premium imported belts & caps â€” leather belts, fashion belts, caps and hats." },
  'accessories/nails': { title: "Imported Nail Art Supplies India", desc: "Shop imported nail art supplies â€” press-on nails, nail stickers, nail art tools & accessories." },
  'accessories/keychains': { title: "Imported Keychains India", desc: "Cute imported keychains & charms â€” character keychains, aesthetic keychains & premium key accessories." },
};
...
function getCategoryInfo(slugArray) {
  ...
  const displayName = slugArray.map(formatName).reverse().join(' â€” ');
  return {
    name: displayName,
    title: `${displayName} â€” Imported Fashion India | House of Avira`,
